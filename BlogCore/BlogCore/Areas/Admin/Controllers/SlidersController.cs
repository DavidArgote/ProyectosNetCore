    ...
    public class SlidersController : Controller
    {
        ...
        public IActionResult Edit(Slider slider)
        {
            if (ModelState.IsValid)
            {
                ...
                var sliderDesdeBb = _contenedorTrabajo.Slider.Get(slider.Id);
                ...
                if (archivos.Count() > 0)
                {
                    ...
                    var rutaImagen = Path.Combine(rutaPrincipal, sliderDesdeBb.UrlImagen.TrimStart('\\'));
                    ...
                    _contenedorTrabajo.Slider.Update(slider); // Actualizar
                    _contenedorTrabajo.Save();
                ...
                {
                    slider.UrlImagen = sliderDesdeBb.UrlImagen;
                }
